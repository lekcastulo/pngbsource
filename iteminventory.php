...
<a href="shipping.php"><li>Deliveries </li></a>
          ...
          <div class="row">
            <div class="col-md-12">        
             ...
             <?php 
              ...
              <h5 style="color: purple";><b>Add/Remove Item</b></h5>
              ...
              <div class="input-group date" data-provide="datepicker" >
                ...
                <select class="selectpicker show-menu-arrow form-control" name="itemid" id="itemid">
                  <option>All</option>
                ...
                <br>              
                <br>              
                <button type="submit" class="btn btn-info" value="login" name="sum">Submit</button>
              </form>
  ...
  <br>
         ...
         <div class="container">
            <div class="row">
              <div class="col-md-4 col-md-offset-4">
                <form class="form-inline" action="deletetrans.php" method="POST">
                  <label for="accountname">Delete Transaction Number</label><br>
                    <input name="trans" type="number"> <br> <br>
                    <button type="submit" class="btn btn-warning" value="login" name="sum">Submit</button>
                </form>
              </div>
            </div>
          </div>
...
<h4> Total Gold Remaining </h4>
                  <h3 name="totalRemaining"> </h3>
...
<!--         <script src="js/jquery-1.9.1.min.js"></script>
   ...
   <!--      <script type="text/javascript" src="js/salesList.js"></script>
	...
	<script type="text/javascript" src="js/totalgramsremaining.js"></script>
           </body>
