...
<!-- SALES REPORT -->
  <div class="container" style=" background-color: #fff; text-align: center; padding: 10px;">
    ...
    <div class="row">
      ...
      <br><br>
      <a class="btn btn-success" href="editingcustomer.php">Editing Customer</a><br><br>
      <a class="btn btn-success" href="editinggrams.php">Editing Grams</a><br><br>
      <a class="btn btn-success" href="editingsellingprice.php">Editing Price</a><br><br>
      <a class="btn btn-success" href="editingitemtype.php">Editing Item Type</a><br><br>
