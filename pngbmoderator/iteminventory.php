          ...
          <div class="row">
            <div class="col-md-12">        
             ...
             <?php 
              ...
              <h4 style="color: red;"><b>(Overall Items Inventory)</b></h4>
              ...
              <!-- <div class="input-group date" data-provide="datepicker"  > -->
                  <!-- <input type="hidden" type="text" class="form-control" name="date" required> -->
              ...
              <!-- </div><br><br> -->
               ...
               <!--  <select class="selectpicker show-menu-arrow form-control" name="itemOption" type="hidden">
                  <option>Input</option>
