...
<!-- SALES REPORT -->
  <div class="container" style=" background-color: #fff; text-align: center; padding: 10px;">
    ...
    <div class="row">
      <div class="col-md-12">
      <h2><b>BACKTRACK REQUEST</b></h2>

      <h3> Backtrack Change Customer Name Request</h3>


      <div class="jsGrid5"></div>
      ...
      <div class="col-md-12">
        ...
        <a  class="btn btn-danger" href="editbacktrack.php"> Back to Back track menu</a>
        <br>
        <br>
...
<script type="text/javascript" src="js/backtrackcustomers.js"></script> 
</body>
