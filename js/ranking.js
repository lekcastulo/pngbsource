...
ranking += '<td><b>'+numeral(object.grams).format('0,0.00')+'</font></b></td>';
ranking += '<td><b>'+numeral(object.Total_Sales).format('0,0.00')+'</font></b></td>';
		});
...
//		 console.log (data);
	...
	var totalTransaction = function(dateFrom, dateTo){
     ...
     var totalGrams = function(dateFrom, dateTo){

	        var dateFrom = (typeof dateFrom ==='undefined') ? '2017-01-01': dateFrom;
                var dateTo = (typeof dateTo ==='undefined') ? '2030-01-01': dateTo;
		
			$.post('backend/controllers/ranking.php', {type: 'totalGrams', dateFrom: dateFrom, dateTo: dateTo }, function(data){
			console.log(data);
			data = JSON.parse(data);
	                ...
	                $.each(data, function(key, object){
                                ...
                                // console.log(object);
                                $("h3[name=totalGrams]").html('Total Grams: <b>'+numeral(object.totalgrams).format('0,0.00')+'</b>');
