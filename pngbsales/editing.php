...
<div class="row">
         ...
         <h3 style="color: orange;"> Change SF</h3> <br>
         <form class="form-inline" action="/editshipping.php" method="POST">
         <input type="hidden" name="date" value="<?php echo date("Y-m-d") ?>" />
                    <input type="hidden" name="id" value="<?php echo $member_id ?>" />         
             <label> Choose the Right Payment Method </label><br>
                    <select class="form-control" name="sfoption" required>
                ...
                <label> Input Correct SF Amount</label><br>
                    <input type="amount"  placeholder="SF Amount" class="form-control" name="sfamount" require>  <br><br>

                <label> Input Correct Reference Number</label><br>
                    <input type="amount"  placeholder="Reference Number" class="form-control" name="reference" require>  <br><br>
         ...
         <a href="editcheckshippingfee.php" class="btn btn-warning"> Check Request </a>
