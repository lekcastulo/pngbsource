    ...
    requestCustomer = [];
      ...
      $.each(data, function(key, object){
          ...
          var allData = {
            ...
            "Old Customer Name": object.existing_customername,
            "Requested Customer Name":object.customer_name,
      ...
      $(".jsGrid").jsGrid({
        ...
        fields: [
            ...
            { name: "Old Customer Name", type: "text",  validate: "required" },       
            { name: "Requested Customer Name", type: "text",  validate: "required" },
        ...
        onItemUpdated: function(args) {
          ...
          var customer = args.item['Requested Customer Name'];
