		...
		class editingInventory {
				...
				public function editingCustomerRequest($or, $member, $approval, $customer, $adminreason, $requestno){
					require '../../connection.php';
						...
						if ($approval == 'Not Approved'){
							...
							$query = mysqli_query($connection, "
							UPDATE `script2`.`edit_customername` SET  `status`='Not Approved', `request_status`='$adminreason' WHERE `edit_transaction` = '$requestno'");
						...
						if ($approval == 'Approved'){
							...
							$query = mysqli_query($connection, "
							UPDATE `script2`.`edit_customername` SET `customer_name`='$customer',  `status`='Approved', `request_status`='ok' WHERE `edit_transaction` = '$requestno'
				...
				public function editingGramsRequest($or, $member, $approval, $grams, $adminreason, $requestno){
						require '../../connection.php';
							...
							if ($approval == 'Not Approved'){
								...
								$query = mysqli_query($connection, "
								UPDATE `script2`.`edit_gram` SET   `status`='Not Approved', `request_status`='$adminreason' WHERE `edit_transaction` = '$requestno'");
							...
							if ($approval == 'Approved'){
								...
								$query = mysqli_query($connection, "
								UPDATE `script2`.`edit_gram` SET `grams`='$grams',  `status`='Approved', `request_status`='ok' WHERE `edit_transaction` = '$requestno'
				...
				public function backtrackGrams(){
					require '../../connection.php';
							...
							$query = mysqli_query($connection, "
							SELECT member.member_id, member.firstname, member.secondname, edit_gram.edit_transaction, edit_gram.grams, edit_gram.date, edit_gram.or_number, edit_gram.reason, edit_gram.existing_grams, edit_gram.status  FROM script2.edit_gram, member where member.member_id = edit_gram.member_id  ORDER BY date DESC;");
				...
				public function editingSellingprice(){
					require '../../connection.php';
							...
							$query = mysqli_query($connection, "
							SELECT member.member_id, member.firstname, member.secondname, edit_sellingprice.edit_transaction, edit_sellingprice.sellingprice, edit_sellingprice.date, edit_sellingprice.or_number, edit_sellingprice.reason, edit_sellingprice.status , edit_sellingprice.or_date , edit_sellingprice.existing_sellingprice FROM script2.edit_sellingprice, member where member.member_id = edit_sellingprice.member_id and edit_sellingprice.status = 'For Edit' ORDER BY date DESC;");
				...
				public function editingSellingpriceRequest($or, $member, $approval, $sellingprice, $adminreason, $requestno){
					require '../../connection.php';
						...
						if ($approval == 'Not Approved'){
							...
							$query = mysqli_query($connection, "
							UPDATE `script2`.`edit_sellingprice` SET   `status`='Not Approved', `request_status`='$adminreason' WHERE `edit_transaction` = '$requestno'");
						...
						if ($approval == 'Approved'){
							...
							$query = mysqli_query($connection, "
							UPDATE `script2`.`edit_sellingprice` SET `sellingprice`='$sellingprice',  `status`='Approved', `request_status`='ok' WHERE `edit_transaction` = '$requestno'
				...
				public function backtrackSellingprice(){
					require '../../connection.php';
							...
							$query = mysqli_query($connection, "
							SELECT member.member_id, member.firstname, member.secondname, edit_sellingprice.edit_transaction, edit_sellingprice.sellingprice, edit_sellingprice.date, edit_sellingprice.or_number, edit_sellingprice.reason, edit_sellingprice.status , edit_sellingprice.existing_sellingprice FROM script2.edit_sellingprice, member where member.member_id = edit_sellingprice.member_id ORDER BY date DESC;");
				...
				public function editingItemTypeRequest($or, $member, $approval, $changeitem, $itemvalue, $itemid, $adminreason, $requestno){
					require '../../connection.php';
						...
						if ($approval == 'Not Approved'){
							...
							$query = mysqli_query($connection, "
							UPDATE `script2`.`edit_changeitemtype` SET   `status`='Not Approved', `request_status`='$adminreason' WHERE `edit_transaction` = '$requestno'");
						...
						if ($approval == 'Approved'){
							...
							$query = mysqli_query($connection, "
							UPDATE `script2`.`edit_changeitemtype` SET `changeitem`='$changeitem',  `status`='Approved', `request_status`='ok' WHERE `edit_transaction` = '$requestno'
				...
				public function backtrackItemType(){
					require '../../connection.php';
							...
							$query = mysqli_query($connection, "
							SELECT member.member_id, member.firstname, member.secondname, edit_changeitemtype.edit_transaction, edit_changeitemtype.changeitem, edit_changeitemtype.itemvalue, edit_changeitemtype.itemid, edit_changeitemtype.date, edit_changeitemtype.or_number, edit_changeitemtype.reason, edit_changeitemtype.status , edit_changeitemtype.or_date , edit_changeitemtype.existing_itemtype  FROM script2.edit_changeitemtype, member where member.member_id = edit_changeitemtype.member_id ORDER BY date DESC;");
