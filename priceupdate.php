...
<!-- 
  <div class="input-daterange" id="datepicker" >
     ...
     <input type="hidden" name="accountnameid" value="<?php echo $member_id ?>" />
...
<center>
  ...
  <!-- <h3 name="totalSales"> </h3>
  <h3 name="totalTransaction"> </h3> <br>
